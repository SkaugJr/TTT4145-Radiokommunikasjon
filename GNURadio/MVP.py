...
class MVP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_fll_band_edge_cc_0 = digital.fll_band_edge_cc(sps, excess_BW, 24, 0.05)
        ...
        self.digital_costas_loop_cc_0 = digital.costas_loop_cc(0.225, 4, False)
