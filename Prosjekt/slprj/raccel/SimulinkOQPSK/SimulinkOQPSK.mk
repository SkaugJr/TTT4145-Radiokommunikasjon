###########################################################################
## Makefile generated for component 'SimulinkOQPSK'. 
## 
## Makefile     : SimulinkOQPSK.mk
## Generated on : Sun Feb 09 12:15:31 2025
## Final product: ./SimulinkOQPSK.exe
...
COMPILER_COMMAND_FILE     = SimulinkOQPSK_comp.rsp
CMD_FILE                  = SimulinkOQPSK.rsp
...
DEFINES_STANDARD = -DMODEL=SimulinkOQPSK -DNUMST=4 -DNCSTATES=0 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK.c $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK_capi.c $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK_data.c $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK_tgtconn.c $(START_DIR)/slprj/raccel/SimulinkOQPSK/rtGetNaN.c $(START_DIR)/slprj/raccel/SimulinkOQPSK/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = SimulinkOQPSK.obj SimulinkOQPSK_capi.obj SimulinkOQPSK_data.obj SimulinkOQPSK_tgtconn.obj rtGetNaN.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
LIBS = $(MATLAB_ROOT)/extern/lib/win64/mingw64/libmwdsp_halidesim.lib
...
%.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SimulinkOQPSK.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkOQPSK_capi.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkOQPSK_data.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkOQPSK_tgtconn.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/SimulinkOQPSK_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/SimulinkOQPSK/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
