...
#include "m_BBcc5z5aeUdmJfBvWAEeM.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[1000000], creal_T
  c_y0[1000000]);
static void CarrierSynchronizer_stepImpl(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance, const emlrtStack *sp, comm_CarrierSynchronizer *obj, creal_T
  input[1000000], creal_T output[1000000]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
...
static void cgxe_mdl_set_sim_state(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
...
static void carrierSyncCore(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance,
  const emlrtStack *sp, creal_T input[1000000], real_T *loopFiltState, real_T
  *integFiltState, real_T *DDSPreviousInp, coder_array_creal_T_2D
  *prevHalfSymbol, real_T *phase, real_T *digitalSynthesizerGain, real_T
  *integratorGain, real_T *proportionalGain, real_T *phaseOffset, creal_T
  output[1000000], real_T b_phaseEstimate[1000000], coder_array_creal_T_2D
  *prevHalfSymbolOut);
...
static void init_simulink_io_address(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance);
...
static void SystemCore_setup(const emlrtStack *sp, comm_CarrierSynchronizer *obj)
{
  ...
  static uint32_T uv[8] = { 1000000U, 1U, 1U, 1U, 1U, 1U, 1U, 1U };
  ...
  CarrierSynchronizer_validatePropertiesImpl(&b_st, obj);
  st.site = &e_emlrtRSI;
  obj->pPhase = 0.0;
  ...
  PhaseRecoveryLoopBandwidth = emlrtNonNegativeCheckR2012b
    (PhaseRecoveryLoopBandwidth, &b_emlrtDCI, &st);
...
static void mw__internal__call__step(InstanceStruct_BBcc5z5aeUdmJfBvWAEeM
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  ...
  c_y0[1000000])
{
  static uint32_T inSize[8] = { 1000000U, 1U, 1U, 1U, 1U, 1U, 1U, 1U };
  ...
  *prevHalfSymbolOut)
{
  ...
  for (i = 0; i < 1000000; i++) {
    b_phaseEstimate[i] = -(moduleInstance->phaseCorrection[i].re + *phaseOffset);
  }
}
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[1000000])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[1000000])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S, int_T tid)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S, int_T tid)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void setSimState_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
  InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *moduleInstance =
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM *)calloc(1, sizeof
    (InstanceStruct_BBcc5z5aeUdmJfBvWAEeM));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_BBcc5z5aeUdmJfBvWAEeM);
  ssSetmdlInitializeConditions(S, mdlInitialize_BBcc5z5aeUdmJfBvWAEeM);
  ssSetmdlUpdate(S, mdlUpdate_BBcc5z5aeUdmJfBvWAEeM);
  ssSetmdlDerivatives(S, mdlDerivatives_BBcc5z5aeUdmJfBvWAEeM);
  ssSetmdlTerminate(S, mdlTerminate_BBcc5z5aeUdmJfBvWAEeM);
  ssSetmdlEnable(S, mdlEnable_BBcc5z5aeUdmJfBvWAEeM);
  ssSetmdlDisable(S, mdlDisable_BBcc5z5aeUdmJfBvWAEeM);
...
static void mdlProcessParameters_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S)
{
}

void method_dispatcher_BBcc5z5aeUdmJfBvWAEeM(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_BBcc5z5aeUdmJfBvWAEeM(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_BBcc5z5aeUdmJfBvWAEeM(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_BBcc5z5aeUdmJfBvWAEeM(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_BBcc5z5aeUdmJfBvWAEeM(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: BBcc5z5aeUdmJfBvWAEeM.\n"
...
mxArray *cgxe_BBcc5z5aeUdmJfBvWAEeM_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_BBcc5z5aeUdmJfBvWAEeM_fallback_info(void)
{
