...
#include "m_jrm8lDRMBs7tXcPYkzM3QB.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[88000], creal_T
  c_y0[88000]);
static void CarrierSynchronizer_stepImpl(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance, const emlrtStack *sp, comm_CarrierSynchronizer *obj, creal_T
  input[88000], creal_T output[88000]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
...
static void carrierSyncCore(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance, const emlrtStack *sp, creal_T input[88000], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[88000], real_T b_phaseEstimate[88000],
...
static void init_simulink_io_address(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance);
...
static void SystemCore_setup(const emlrtStack *sp, comm_CarrierSynchronizer *obj)
{
  ...
  static uint32_T uv[8] = { 88000U, 1U, 1U, 1U, 1U, 1U, 1U, 1U };
...
static void mw__internal__call__step(InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  ...
  c_y0[88000])
{
  static uint32_T inSize[8] = { 88000U, 1U, 1U, 1U, 1U, 1U, 1U, 1U };
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[88000])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[88000])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S, int_T tid)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S, int_T tid)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
  InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *moduleInstance =
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB *)calloc(1, sizeof
    (InstanceStruct_jrm8lDRMBs7tXcPYkzM3QB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_jrm8lDRMBs7tXcPYkzM3QB);
  ssSetmdlInitializeConditions(S, mdlInitialize_jrm8lDRMBs7tXcPYkzM3QB);
  ssSetmdlUpdate(S, mdlUpdate_jrm8lDRMBs7tXcPYkzM3QB);
  ssSetmdlDerivatives(S, mdlDerivatives_jrm8lDRMBs7tXcPYkzM3QB);
  ssSetmdlTerminate(S, mdlTerminate_jrm8lDRMBs7tXcPYkzM3QB);
  ssSetmdlEnable(S, mdlEnable_jrm8lDRMBs7tXcPYkzM3QB);
  ssSetmdlDisable(S, mdlDisable_jrm8lDRMBs7tXcPYkzM3QB);
...
static void mdlProcessParameters_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S)
{
}

void method_dispatcher_jrm8lDRMBs7tXcPYkzM3QB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_jrm8lDRMBs7tXcPYkzM3QB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_jrm8lDRMBs7tXcPYkzM3QB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_jrm8lDRMBs7tXcPYkzM3QB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_jrm8lDRMBs7tXcPYkzM3QB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: jrm8lDRMBs7tXcPYkzM3QB.\n"
...
mxArray *cgxe_jrm8lDRMBs7tXcPYkzM3QB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_jrm8lDRMBs7tXcPYkzM3QB_fallback_info(void)
{
