...
#include "m_0GZJVrS4PICaqlVNdL0RsF.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[552], creal_T
  c_y0[552]);
static void CarrierSynchronizer_stepImpl(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj, creal_T input[552], creal_T output[552]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
...
static void carrierSyncCore(const emlrtStack *sp, creal_T input[552], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[552], real_T phaseEstimate[552],
...
static void init_simulink_io_address(InstanceStruct_0GZJVrS4PICaqlVNdL0RsF
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 552, 1, 1, 1, 1, 1, 1, 1 };
  ...
  c_y0[552])
{
  ...
  static int16_T inSize[8] = { 552, 1, 1, 1, 1, 1, 1, 1 };
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[552])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[552])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S, int_T tid)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S, int_T tid)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
  InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *moduleInstance =
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF *)calloc(1, sizeof
    (InstanceStruct_0GZJVrS4PICaqlVNdL0RsF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_0GZJVrS4PICaqlVNdL0RsF);
  ssSetmdlInitializeConditions(S, mdlInitialize_0GZJVrS4PICaqlVNdL0RsF);
  ssSetmdlUpdate(S, mdlUpdate_0GZJVrS4PICaqlVNdL0RsF);
  ssSetmdlDerivatives(S, mdlDerivatives_0GZJVrS4PICaqlVNdL0RsF);
  ssSetmdlTerminate(S, mdlTerminate_0GZJVrS4PICaqlVNdL0RsF);
  ssSetmdlEnable(S, mdlEnable_0GZJVrS4PICaqlVNdL0RsF);
  ssSetmdlDisable(S, mdlDisable_0GZJVrS4PICaqlVNdL0RsF);
...
static void mdlProcessParameters_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S)
{
}

void method_dispatcher_0GZJVrS4PICaqlVNdL0RsF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_0GZJVrS4PICaqlVNdL0RsF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_0GZJVrS4PICaqlVNdL0RsF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_0GZJVrS4PICaqlVNdL0RsF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_0GZJVrS4PICaqlVNdL0RsF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 0GZJVrS4PICaqlVNdL0RsF.\n"
...
mxArray *cgxe_0GZJVrS4PICaqlVNdL0RsF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_0GZJVrS4PICaqlVNdL0RsF_fallback_info(void)
{
