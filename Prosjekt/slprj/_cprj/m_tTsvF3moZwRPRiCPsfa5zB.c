...
#include "m_tTsvF3moZwRPRiCPsfa5zB.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[1152], creal_T
  c_y0[1152]);
static void CarrierSynchronizer_stepImpl(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj, creal_T input[1152], creal_T output[1152]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
...
static void carrierSyncCore(const emlrtStack *sp, creal_T input[1152], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[1152], real_T phaseEstimate[1152],
...
static void init_simulink_io_address(InstanceStruct_tTsvF3moZwRPRiCPsfa5zB
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 1152, 1, 1, 1, 1, 1, 1, 1 };
  ...
  c_y0[1152])
{
  ...
  static int16_T inSize[8] = { 1152, 1, 1, 1, 1, 1, 1, 1 };
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[1152])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[1152])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S, int_T tid)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S, int_T tid)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
  InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *moduleInstance =
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB *)calloc(1, sizeof
    (InstanceStruct_tTsvF3moZwRPRiCPsfa5zB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_tTsvF3moZwRPRiCPsfa5zB);
  ssSetmdlInitializeConditions(S, mdlInitialize_tTsvF3moZwRPRiCPsfa5zB);
  ssSetmdlUpdate(S, mdlUpdate_tTsvF3moZwRPRiCPsfa5zB);
  ssSetmdlDerivatives(S, mdlDerivatives_tTsvF3moZwRPRiCPsfa5zB);
  ssSetmdlTerminate(S, mdlTerminate_tTsvF3moZwRPRiCPsfa5zB);
  ssSetmdlEnable(S, mdlEnable_tTsvF3moZwRPRiCPsfa5zB);
  ssSetmdlDisable(S, mdlDisable_tTsvF3moZwRPRiCPsfa5zB);
...
static void mdlProcessParameters_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S)
{
}

void method_dispatcher_tTsvF3moZwRPRiCPsfa5zB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_tTsvF3moZwRPRiCPsfa5zB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_tTsvF3moZwRPRiCPsfa5zB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_tTsvF3moZwRPRiCPsfa5zB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_tTsvF3moZwRPRiCPsfa5zB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: tTsvF3moZwRPRiCPsfa5zB.\n"
...
mxArray *cgxe_tTsvF3moZwRPRiCPsfa5zB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_tTsvF3moZwRPRiCPsfa5zB_fallback_info(void)
{
