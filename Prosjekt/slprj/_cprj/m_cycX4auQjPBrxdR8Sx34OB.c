...
#include "m_cycX4auQjPBrxdR8Sx34OB.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
...
static const mxArray *emlrt_marshallOut(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
...
static void init_simulink_io_address(InstanceStruct_cycX4auQjPBrxdR8Sx34OB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_cycX4auQjPBrxdR8Sx34OB(SimStruct *S, int_T tid)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_cycX4auQjPBrxdR8Sx34OB(SimStruct *S, int_T tid)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_cycX4auQjPBrxdR8Sx34OB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
  InstanceStruct_cycX4auQjPBrxdR8Sx34OB *moduleInstance =
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB *)calloc(1, sizeof
    (InstanceStruct_cycX4auQjPBrxdR8Sx34OB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_cycX4auQjPBrxdR8Sx34OB);
  ssSetmdlInitializeConditions(S, mdlInitialize_cycX4auQjPBrxdR8Sx34OB);
  ssSetmdlUpdate(S, mdlUpdate_cycX4auQjPBrxdR8Sx34OB);
  ssSetmdlDerivatives(S, mdlDerivatives_cycX4auQjPBrxdR8Sx34OB);
  ssSetmdlTerminate(S, mdlTerminate_cycX4auQjPBrxdR8Sx34OB);
  ssSetmdlEnable(S, mdlEnable_cycX4auQjPBrxdR8Sx34OB);
  ssSetmdlDisable(S, mdlDisable_cycX4auQjPBrxdR8Sx34OB);
...
static void mdlProcessParameters_cycX4auQjPBrxdR8Sx34OB(SimStruct *S)
{
}

void method_dispatcher_cycX4auQjPBrxdR8Sx34OB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_cycX4auQjPBrxdR8Sx34OB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_cycX4auQjPBrxdR8Sx34OB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_cycX4auQjPBrxdR8Sx34OB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_cycX4auQjPBrxdR8Sx34OB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: cycX4auQjPBrxdR8Sx34OB.\n"
...
mxArray *cgxe_cycX4auQjPBrxdR8Sx34OB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_cycX4auQjPBrxdR8Sx34OB_fallback_info(void)
{
