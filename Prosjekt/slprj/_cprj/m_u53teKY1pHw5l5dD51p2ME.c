...
#include "m_u53teKY1pHw5l5dD51p2ME.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_u53teKY1pHw5l5dD51p2ME
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[528], creal_T
  c_y0[528]);
static void CarrierSynchronizer_stepImpl(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj, creal_T input[528], creal_T output[528]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_u53teKY1pHw5l5dD51p2ME
...
static void cgxe_mdl_set_sim_state(InstanceStruct_u53teKY1pHw5l5dD51p2ME
...
static void carrierSyncCore(const emlrtStack *sp, creal_T input[528], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[528], real_T phaseEstimate[528],
...
static void init_simulink_io_address(InstanceStruct_u53teKY1pHw5l5dD51p2ME
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 528, 1, 1, 1, 1, 1, 1, 1 };
  ...
  c_y0[528])
{
  ...
  static int16_T inSize[8] = { 528, 1, 1, 1, 1, 1, 1, 1 };
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[528])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[528])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_u53teKY1pHw5l5dD51p2ME(SimStruct *S, int_T tid)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_u53teKY1pHw5l5dD51p2ME(SimStruct *S, int_T tid)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void setSimState_u53teKY1pHw5l5dD51p2ME(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
  InstanceStruct_u53teKY1pHw5l5dD51p2ME *moduleInstance =
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME *)calloc(1, sizeof
    (InstanceStruct_u53teKY1pHw5l5dD51p2ME));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_u53teKY1pHw5l5dD51p2ME);
  ssSetmdlInitializeConditions(S, mdlInitialize_u53teKY1pHw5l5dD51p2ME);
  ssSetmdlUpdate(S, mdlUpdate_u53teKY1pHw5l5dD51p2ME);
  ssSetmdlDerivatives(S, mdlDerivatives_u53teKY1pHw5l5dD51p2ME);
  ssSetmdlTerminate(S, mdlTerminate_u53teKY1pHw5l5dD51p2ME);
  ssSetmdlEnable(S, mdlEnable_u53teKY1pHw5l5dD51p2ME);
  ssSetmdlDisable(S, mdlDisable_u53teKY1pHw5l5dD51p2ME);
...
static void mdlProcessParameters_u53teKY1pHw5l5dD51p2ME(SimStruct *S)
{
}

void method_dispatcher_u53teKY1pHw5l5dD51p2ME(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_u53teKY1pHw5l5dD51p2ME(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_u53teKY1pHw5l5dD51p2ME(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_u53teKY1pHw5l5dD51p2ME(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_u53teKY1pHw5l5dD51p2ME(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: u53teKY1pHw5l5dD51p2ME.\n"
...
mxArray *cgxe_u53teKY1pHw5l5dD51p2ME_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_u53teKY1pHw5l5dD51p2ME_fallback_info(void)
{
