...
#include "m_T6sVOZyhM4n9stjG4jmWdD.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0_data[], int32_T
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2]);
static const mxArray *emlrt_marshallOut(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
...
static void init_simulink_io_address(InstanceStruct_T6sVOZyhM4n9stjG4jmWdD
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  creal_T u_tmp3_data[49];
  creal_T y_tmp0_data[49];
  real_T *DampingFactor;
  real_T *NormalizedLoopBandwidth;
  real_T *SamplesPerSymbol;
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int8_T iv1[8] = { 49, 1, 1, 1, 1, 1, 1, 1 };
  ...
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2])
{
  ...
  b_st.site = &e_emlrtRSI;
  loopFiltOut = moduleInstance->sysobj.pLoopFilterState;
  DDSOut = moduleInstance->sysobj.pIntegFilterState;
  DDSPreviousInp = moduleInstance->sysobj.pDDSPreviousInput;
  previousSample_re = moduleInstance->sysobj.pPreviousSample.re;
  previousSample_im = moduleInstance->sysobj.pPreviousSample.im;
  ...
  PhaseRecoveryLoopBandwidth = moduleInstance->sysobj.pPhase;
  ...
  for (k = 0; k < i; k++) {
    if (tPrevHalfSymbol.size[1] < 2) {
      ...
      i2 = emlrtDynamicBoundsCheckR2012b(tPrevHalfSymbol.size[1], 1,
        tPrevHalfSymbol.size[1], &emlrtBCI, &c_st);
    }
    ...
    tPrevHalfSymbol.vector.data[i3].re = b_u0_data[emlrtDynamicBoundsCheckR2012b
      (k + 1, 1, u0_size[0], &c_emlrtBCI, &c_st) - 1].re;
    tPrevHalfSymbol.vector.data[i3].im = b_u0_data[emlrtDynamicBoundsCheckR2012b
      (k + 1, 1, u0_size[0], &c_emlrtBCI, &c_st) - 1].im;
    d_st.site = &y_emlrtRSI;
    d = sin(PhaseRecoveryLoopBandwidth);
    PhaseRecoveryGain = cos(PhaseRecoveryLoopBandwidth);
    array_creal_T_2D_SetSize(&prevHalfSymbol, 1, tPrevHalfSymbol.size[1]);
    ret = tPrevHalfSymbol.size[1];
    for (i1 = 0; i1 < ret; i1++) {
      PhaseRecoveryLoopBandwidth = tPrevHalfSymbol.vector.data[i1].re *
        PhaseRecoveryGain - tPrevHalfSymbol.vector.data[i1].im * d;
      im = tPrevHalfSymbol.vector.data[i1].re * d +
        tPrevHalfSymbol.vector.data[i1].im * PhaseRecoveryGain;
      prevHalfSymbol.vector.data[i1].re = PhaseRecoveryLoopBandwidth;
      prevHalfSymbol.vector.data[i1].im = im;
    }

    output_data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, output_size_idx_0,
      &e_emlrtBCI, &c_st) - 1].re =
      prevHalfSymbol.vector.data[emlrtDynamicBoundsCheckR2012b
      (prevHalfSymbol.size[1], 1, prevHalfSymbol.size[1], &d_emlrtBCI, &c_st) -
      1].re;
    output_data[emlrtDynamicBoundsCheckR2012b(k + 1, 1, output_size_idx_0,
      &e_emlrtBCI, &c_st) - 1].im =
      prevHalfSymbol.vector.data[emlrtDynamicBoundsCheckR2012b
      (prevHalfSymbol.size[1], 1, prevHalfSymbol.size[1], &d_emlrtBCI, &c_st) -
      1].im;
    d_st.site = &ab_emlrtRSI;
    e_st.site = &db_emlrtRSI;
    PhaseRecoveryLoopBandwidth = signDouble(prevHalfSymbol.vector.data[0].re);
    d_st.site = &bb_emlrtRSI;
    emlrtDynamicBoundsCheckR2012b(prevHalfSymbol.size[1], 1,
      prevHalfSymbol.size[1], &b_emlrtBCI, &d_st);
    e_st.site = &db_emlrtRSI;
    d = signDouble(prevHalfSymbol.vector.data[prevHalfSymbol.size[1] - 1].im);
    PhaseRecoveryLoopBandwidth = PhaseRecoveryLoopBandwidth *
      prevHalfSymbol.vector.data[0].im - d *
      prevHalfSymbol.vector.data[emlrtDynamicBoundsCheckR2012b
      (prevHalfSymbol.size[1], 1, prevHalfSymbol.size[1], &f_emlrtBCI, &c_st) -
      1].re;
    loopFiltOut += PhaseRecoveryLoopBandwidth * integratorGain;
    DDSOut += DDSPreviousInp;
    DDSPreviousInp = PhaseRecoveryLoopBandwidth * proportionalGain + loopFiltOut;
    PhaseRecoveryLoopBandwidth = digitalSynthesizerGain * DDSOut;
    emlrtDynamicBoundsCheckR2012b(k + 1, 1, u0_size[0], &g_emlrtBCI, &c_st);
  }

  array_creal_T_2D_Destructor(&prevHalfSymbol);
  d_st.site = &cb_emlrtRSI;
  d = sin(phaseOffset);
  PhaseRecoveryGain = cos(phaseOffset);
  for (i = 0; i < output_size_idx_0; i++) {
    b_output_data = output_data[i];
    im = b_output_data.re * d + b_output_data.im * PhaseRecoveryGain;
    b_output_data.re = b_output_data.re * PhaseRecoveryGain - b_output_data.im *
      d;
    b_output_data.im = im;
  ...
  array_creal_T_2D_SetSize(&moduleInstance->sysobj.pPreviousHalfSymbol, 1,
    tPrevHalfSymbol.size[1]);
  ret = tPrevHalfSymbol.size[1];
  for (i = 0; i < ret; i++) {
    moduleInstance->sysobj.pPreviousHalfSymbol.vector.data[i].re =
      tPrevHalfSymbol.vector.data[i].re;
    moduleInstance->sysobj.pPreviousHalfSymbol.vector.data[i].im =
      tPrevHalfSymbol.vector.data[i].im;
  }

  array_creal_T_2D_Destructor(&tPrevHalfSymbol);
  moduleInstance->sysobj.pPhase = PhaseRecoveryLoopBandwidth;
  ...
  b_st.site = &e_emlrtRSI;
  SystemCore_checkTunablePropChange(&b_st, &moduleInstance->sysobj);
  emlrtDimSizeGeqCheckR2012b(49, u0_size[0], &emlrtECI, (void *)sp);
  y0_size[0] = u0_size[0];
  y0_size[1] = 1;
  if (u0_size[0] - 1 >= 0) {
    memcpy(&b_y0_data[0], &output_data[0], (uint32_T)u0_size[0] * sizeof(creal_T));
  }
}
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0_data = (creal_T (*)[49])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->u0_sizes = (int32_T (*)[2])cgxertGetCurrentInputPortDimensions
    (moduleInstance->S, 0);
  moduleInstance->y0_data = (creal_T (*)[49])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
...
/* CGXE Glue Code */
static void mdlOutputs_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S, int_T tid)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S, int_T tid)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
  InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *moduleInstance =
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD *)calloc(1, sizeof
    (InstanceStruct_T6sVOZyhM4n9stjG4jmWdD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_T6sVOZyhM4n9stjG4jmWdD);
  ssSetmdlInitializeConditions(S, mdlInitialize_T6sVOZyhM4n9stjG4jmWdD);
  ssSetmdlUpdate(S, mdlUpdate_T6sVOZyhM4n9stjG4jmWdD);
  ssSetmdlDerivatives(S, mdlDerivatives_T6sVOZyhM4n9stjG4jmWdD);
  ssSetmdlTerminate(S, mdlTerminate_T6sVOZyhM4n9stjG4jmWdD);
  ssSetmdlEnable(S, mdlEnable_T6sVOZyhM4n9stjG4jmWdD);
  ssSetmdlDisable(S, mdlDisable_T6sVOZyhM4n9stjG4jmWdD);
...
static void mdlProcessParameters_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S)
{
}

void method_dispatcher_T6sVOZyhM4n9stjG4jmWdD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_T6sVOZyhM4n9stjG4jmWdD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_T6sVOZyhM4n9stjG4jmWdD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_T6sVOZyhM4n9stjG4jmWdD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_T6sVOZyhM4n9stjG4jmWdD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: T6sVOZyhM4n9stjG4jmWdD.\n"
...
mxArray *cgxe_T6sVOZyhM4n9stjG4jmWdD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_T6sVOZyhM4n9stjG4jmWdD_fallback_info(void)
{
