...
#include "m_H9zKsPpkg8iStPZuQ2ResG.h"
#include <string.h>
...
static emlrtRSInfo r_emlrtRSI = { 259, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};

static emlrtRSInfo s_emlrtRSI = { 302, /* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo ab_emlrtRSI = { 412,/* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};

static emlrtRSInfo bb_emlrtRSI = { 334,/* lineNo */
  "CarrierSynchronizer",               /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\CarrierSynchronizer.m"/* pathName */
};
...
static emlrtRSInfo gb_emlrtRSI = { 138,/* lineNo */
  "carrierSyncCore",                   /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\comm\\comm\\+comm\\+internal\\+carrierSync\\carrierSyncCore.m"/* pathName */
};
...
static emlrtRSInfo nb_emlrtRSI = { 22, /* lineNo */
  "validategt",                        /* fcnName */
  "C:\\Program Files\\MATLAB\\R2024b\\toolbox\\eml\\eml\\+coder\\+internal\\+valattr\\validategt.m"/* pathName */
};

/* Function Declarations */
static void cgxe_mdl_start(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance, const emlrtStack *sp, real_T CustomPhaseOffset, real_T
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth,
  creal_T b_u0[352], creal_T c_y0[352]);
static void CarrierSynchronizer_stepImpl(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj, creal_T input[352], creal_T output[352]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
...
static void carrierSyncCore(const emlrtStack *sp, creal_T input[352], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[352], real_T phaseEstimate[352],
...
static void init_simulink_io_address(InstanceStruct_H9zKsPpkg8iStPZuQ2ResG
  *moduleInstance);
  ...
  SamplesPerSymbol, real_T DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 352, 1, 1, 1, 1, 1, 1, 1 };
  ...
  comm_CarrierSynchronizer *obj)
{
  ...
  unnamed_idx_1 = (int32_T)emlrtIntegerCheckR2012b(PhaseRecoveryLoopBandwidth,
    &emlrtDCI, (emlrtConstCTX)sp);
  array_creal_T_2D_SetSize(&obj->pPreviousHalfSymbol, 1, unnamed_idx_1);
  ...
  creal_T b_u0[352], creal_T c_y0[352])
{
  ...
  static int16_T inSize[8] = { 352, 1, 1, 1, 1, 1, 1, 1 };
  ...
  if (moduleInstance->sysobj.CustomPhaseOffset != CustomPhaseOffset) {
    st.site = &u_emlrtRSI;
    b_st.site = &d_emlrtRSI;
    if (moduleInstance->sysobj.isInitialized == 1) {
      moduleInstance->sysobj.TunablePropsChanged = true;
  ...
  b_st.site = &e_emlrtRSI;
  CarrierSynchronizer_stepImpl(&b_st, &moduleInstance->sysobj, b_u0, c_y0);
  b_st.site = &e_emlrtRSI;
  SystemCore_checkTunablePropChange(&b_st, &moduleInstance->sysobj);
}
  ...
  comm_CarrierSynchronizer *obj, creal_T input[352], creal_T output[352])
{
  ...
  carrierSyncCore(&st, input, &loopFiltState, &integFiltState, &DDSPreviousInp,
                  ...
                  phaseEstimate, &b_prevHalfSymbol);
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[352])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[352])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S, int_T tid)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S, int_T tid)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
  InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *moduleInstance =
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG *)calloc(1, sizeof
    (InstanceStruct_H9zKsPpkg8iStPZuQ2ResG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_H9zKsPpkg8iStPZuQ2ResG);
  ssSetmdlInitializeConditions(S, mdlInitialize_H9zKsPpkg8iStPZuQ2ResG);
  ssSetmdlUpdate(S, mdlUpdate_H9zKsPpkg8iStPZuQ2ResG);
  ssSetmdlDerivatives(S, mdlDerivatives_H9zKsPpkg8iStPZuQ2ResG);
  ssSetmdlTerminate(S, mdlTerminate_H9zKsPpkg8iStPZuQ2ResG);
  ssSetmdlEnable(S, mdlEnable_H9zKsPpkg8iStPZuQ2ResG);
  ssSetmdlDisable(S, mdlDisable_H9zKsPpkg8iStPZuQ2ResG);
...
static void mdlProcessParameters_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S)
{
}

void method_dispatcher_H9zKsPpkg8iStPZuQ2ResG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_H9zKsPpkg8iStPZuQ2ResG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_H9zKsPpkg8iStPZuQ2ResG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_H9zKsPpkg8iStPZuQ2ResG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_H9zKsPpkg8iStPZuQ2ResG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: H9zKsPpkg8iStPZuQ2ResG.\n"
...
mxArray *cgxe_H9zKsPpkg8iStPZuQ2ResG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_H9zKsPpkg8iStPZuQ2ResG_fallback_info(void)
{
