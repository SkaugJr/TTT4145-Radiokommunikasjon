...
#include "m_iyikUgX6du35LKHEOXNm7G.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_iyikUgX6du35LKHEOXNm7G
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[576], creal_T
  c_y0[576]);
static void CarrierSynchronizer_stepImpl(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj, creal_T input[576], creal_T output[576]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_iyikUgX6du35LKHEOXNm7G
...
static void cgxe_mdl_set_sim_state(InstanceStruct_iyikUgX6du35LKHEOXNm7G
...
static void carrierSyncCore(const emlrtStack *sp, creal_T input[576], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[576], real_T phaseEstimate[576],
...
static void init_simulink_io_address(InstanceStruct_iyikUgX6du35LKHEOXNm7G
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 576, 1, 1, 1, 1, 1, 1, 1 };
  ...
  c_y0[576])
{
  ...
  static int16_T inSize[8] = { 576, 1, 1, 1, 1, 1, 1, 1 };
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[576])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[576])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_iyikUgX6du35LKHEOXNm7G(SimStruct *S, int_T tid)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_iyikUgX6du35LKHEOXNm7G(SimStruct *S, int_T tid)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void setSimState_iyikUgX6du35LKHEOXNm7G(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
  InstanceStruct_iyikUgX6du35LKHEOXNm7G *moduleInstance =
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G *)calloc(1, sizeof
    (InstanceStruct_iyikUgX6du35LKHEOXNm7G));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_iyikUgX6du35LKHEOXNm7G);
  ssSetmdlInitializeConditions(S, mdlInitialize_iyikUgX6du35LKHEOXNm7G);
  ssSetmdlUpdate(S, mdlUpdate_iyikUgX6du35LKHEOXNm7G);
  ssSetmdlDerivatives(S, mdlDerivatives_iyikUgX6du35LKHEOXNm7G);
  ssSetmdlTerminate(S, mdlTerminate_iyikUgX6du35LKHEOXNm7G);
  ssSetmdlEnable(S, mdlEnable_iyikUgX6du35LKHEOXNm7G);
  ssSetmdlDisable(S, mdlDisable_iyikUgX6du35LKHEOXNm7G);
...
static void mdlProcessParameters_iyikUgX6du35LKHEOXNm7G(SimStruct *S)
{
}

void method_dispatcher_iyikUgX6du35LKHEOXNm7G(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_iyikUgX6du35LKHEOXNm7G(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_iyikUgX6du35LKHEOXNm7G(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_iyikUgX6du35LKHEOXNm7G(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_iyikUgX6du35LKHEOXNm7G(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: iyikUgX6du35LKHEOXNm7G.\n"
...
mxArray *cgxe_iyikUgX6du35LKHEOXNm7G_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_iyikUgX6du35LKHEOXNm7G_fallback_info(void)
{
