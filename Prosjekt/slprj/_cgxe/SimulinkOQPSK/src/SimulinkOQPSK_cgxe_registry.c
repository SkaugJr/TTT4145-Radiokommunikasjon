...
static mxArray* cgxe_get_supported_modules(void)
{
  ...
  checksumData[0] = 2450335090;
  checksumData[1] = 2006579380;
  checksumData[2] = 1904280578;
  checksumData[3] = 1919855142;
  ...
  mxArray* prhs[])
{
...

  {
    ...
    checksumData[0] = 4253413233;
    checksumData[1] = 3088717325;
    checksumData[2] = 1852741316;
    checksumData[3] = 3070684247;
...

  {
    ...
    checksumData[0] = 3687619930;
    checksumData[1] = 612785666;
    checksumData[2] = 2839878159;
    checksumData[3] = 3336032016;
...

  {
    ...
    checksumData[0] = 2456565515;
    checksumData[1] = 505089552;
    checksumData[2] = 3417854152;
    checksumData[3] = 2910928609;
  ...
  mxArray * prhs[])
{
  ...
  if (strcmp(tpChksum, "ydbrxMPHi55Q7lYdpZ3ik") == 0) {
    extern mxArray *cgxe_ydbrxMPHi55Q7lYdpZ3ik_BuildInfoUpdate(void);
    plhs[0] = cgxe_ydbrxMPHi55Q7lYdpZ3ik_BuildInfoUpdate();
    return 1;
  }
  ...
  mxArray * prhs[])
{
  ...
  tpChksum[(sizeof(tpChksum)/sizeof(char)-1)] = '\0';
  if (strcmp(tpChksum, "ydbrxMPHi55Q7lYdpZ3ik") == 0) {
    extern mxArray *cgxe_ydbrxMPHi55Q7lYdpZ3ik_fallback_info(void);
    plhs[0] = cgxe_ydbrxMPHi55Q7lYdpZ3ik_fallback_info();
    return 1;
  }
