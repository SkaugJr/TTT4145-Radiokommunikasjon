#ifndef __ChvisIn7Zfkq5Mc6ef06vC_h__
#define __ChvisIn7Zfkq5Mc6ef06vC_h__
...
#ifndef struct_tag_AerYN3mhQIPlm3q1l1fXWF
#define struct_tag_AerYN3mhQIPlm3q1l1fXWF

struct tag_AerYN3mhQIPlm3q1l1fXWF
{
  ...
  coder_array_creal_T_2D pPreviousHalfSymbol;
};

#endif                                 /* struct_tag_AerYN3mhQIPlm3q1l1fXWF */

#ifndef typedef_comm_CarrierSynchronizer
#define typedef_comm_CarrierSynchronizer

typedef struct tag_AerYN3mhQIPlm3q1l1fXWF comm_CarrierSynchronizer;

#endif                                 /* typedef_comm_CarrierSynchronizer */

#ifndef typedef_InstanceStruct_ChvisIn7Zfkq5Mc6ef06vC
#define typedef_InstanceStruct_ChvisIn7Zfkq5Mc6ef06vC

typedef struct {
  SimStruct *S;
  comm_CarrierSynchronizer sysobj;
  boolean_T sysobj_not_empty;
  creal_T phaseCorrection[1000000];
  real_T phaseEstimate[1000000];
  void *emlrtRootTLSGlobal;
  creal_T (*u0)[1000000];
  creal_T (*b_y0)[1000000];
} InstanceStruct_ChvisIn7Zfkq5Mc6ef06vC;

#endif                                 /* typedef_InstanceStruct_ChvisIn7Zfkq5Mc6ef06vC */
...
extern void method_dispatcher_ChvisIn7Zfkq5Mc6ef06vC(SimStruct *S, int_T method,
  void* data);
