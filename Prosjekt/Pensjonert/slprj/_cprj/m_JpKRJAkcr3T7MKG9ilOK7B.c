...
#include "m_JpKRJAkcr3T7MKG9ilOK7B.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[10000], creal_T
  c_y0[10000]);
static void CarrierSynchronizer_stepImpl(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance, const emlrtStack *sp, comm_CarrierSynchronizer *obj, creal_T
  input[10000], creal_T output[10000]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
...
static void cgxe_mdl_set_sim_state(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
...
static void carrierSyncCore(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance, const emlrtStack *sp, creal_T input[10000], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[10000], real_T phaseEstimate[10000],
...
static void init_simulink_io_address(InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 10000, 1, 1, 1, 1, 1, 1, 1 };
  ...
  c_y0[10000])
{
  ...
  static int16_T inSize[8] = { 10000, 1, 1, 1, 1, 1, 1, 1 };
  ...
  if (!moduleInstance->sysobj_not_empty) {
    ...
    for (ret = 0; ret < 4; ret++) {
      moduleInstance->sysobj.ModulationPhaseOffset[ret] = b[ret];
    }
  ...
  if (moduleInstance->sysobj.isInitialized != 1) {
    ...
    d_st.site = &e_emlrtRSI;
    for (ret = 0; ret < 8; ret++) {
      varSizes[0].f1[ret] = (uint32_T)inSize[ret];
    }
  ...
  b_st.site = &e_emlrtRSI;
  CarrierSynchronizer_stepImpl(moduleInstance, &b_st, &moduleInstance->sysobj,
    b_u0, c_y0);
  b_st.site = &e_emlrtRSI;
  SystemCore_checkTunablePropChange(&b_st, &moduleInstance->sysobj);
}
  ...
  input[10000], creal_T output[10000])
{
  ...
  array_creal_T_2D_SetSize(&prevHalfSymbol, 1, obj->pPreviousHalfSymbol.size[1]);
  loop_ub = obj->pPreviousHalfSymbol.size[1];
  for (i = 0; i < loop_ub; i++) {
    prevHalfSymbol.vector.data[i].re = obj->pPreviousHalfSymbol.vector.data[i].
      re;
    prevHalfSymbol.vector.data[i].im = obj->pPreviousHalfSymbol.vector.data[i].
      im;
  }
  ...
  st.site = &x_emlrtRSI;
  carrierSyncCore(moduleInstance, &st, input, &loopFiltState, &integFiltState,
                  &DDSPreviousInp, &prevHalfSymbol, &phase,
                  &digitalSynthesizerGain, &integratorGain, &proportionalGain,
                  &phaseOffset, output, phaseEstimate, &b_prevHalfSymbol);
  ...
  array_creal_T_2D_SetSize(&obj->pPreviousHalfSymbol, 1, b_prevHalfSymbol.size[1]);
  loop_ub = b_prevHalfSymbol.size[1] - 1;
  for (i = 0; i <= loop_ub; i++) {
    obj->pPreviousHalfSymbol.vector.data[i].re = b_prevHalfSymbol.vector.data[i]
      .re;
    obj->pPreviousHalfSymbol.vector.data[i].im = b_prevHalfSymbol.vector.data[i]
      .im;
  }
  ...
  coder_array_creal_T_2D *prevHalfSymbolOut)
{
  ...
  for (k = 0; k < 10000; k++) {
    ...
    for (b_i = 0; b_i < i; b_i++) {
      loopFiltOut = tPrevHalfSymbol.vector.data[b_i].re * b.re -
        tPrevHalfSymbol.vector.data[b_i].im * b.im;
      DDSOut = tPrevHalfSymbol.vector.data[b_i].re * b.im +
        tPrevHalfSymbol.vector.data[b_i].im * b.re;
      prevHalfSymbolRot.vector.data[b_i].re = loopFiltOut;
      prevHalfSymbolRot.vector.data[b_i].im = DDSOut;
    }
    ...
    b_st.site = &y_emlrtRSI;
    DDSOut = signDouble(prevHalfSymbolRot.vector.data[prevHalfSymbolRot.size[1]
                        - 1].im);
    phErr = loopFiltOut * prevHalfSymbolRot.vector.data[0].im - DDSOut *
    ...
    *phase = *digitalSynthesizerGain * DDSOut;
    ...
    moduleInstance->phaseCorrection[k].im = 0.0;
  }
  ...
  for (b_i = 0; b_i < 10000; b_i++) {
    loopFiltOut = output[b_i].re * b.re - output[b_i].im * b.im;
    DDSOut = output[b_i].re * b.im + output[b_i].im * b.re;
    output[b_i].re = loopFiltOut;
    output[b_i].im = DDSOut;
  }

  for (i = 0; i < 10000; i++) {
    phaseEstimate[i] = -(moduleInstance->phaseCorrection[i].re + *phaseOffset);
  }
}
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[10000])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[10000])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S, int_T tid)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S, int_T tid)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void setSimState_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
  InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *moduleInstance =
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B *)calloc(1, sizeof
    (InstanceStruct_JpKRJAkcr3T7MKG9ilOK7B));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_JpKRJAkcr3T7MKG9ilOK7B);
  ssSetmdlInitializeConditions(S, mdlInitialize_JpKRJAkcr3T7MKG9ilOK7B);
  ssSetmdlUpdate(S, mdlUpdate_JpKRJAkcr3T7MKG9ilOK7B);
  ssSetmdlDerivatives(S, mdlDerivatives_JpKRJAkcr3T7MKG9ilOK7B);
  ssSetmdlTerminate(S, mdlTerminate_JpKRJAkcr3T7MKG9ilOK7B);
  ssSetmdlEnable(S, mdlEnable_JpKRJAkcr3T7MKG9ilOK7B);
  ssSetmdlDisable(S, mdlDisable_JpKRJAkcr3T7MKG9ilOK7B);
...
static void mdlProcessParameters_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S)
{
}

void method_dispatcher_JpKRJAkcr3T7MKG9ilOK7B(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_JpKRJAkcr3T7MKG9ilOK7B(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_JpKRJAkcr3T7MKG9ilOK7B(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_JpKRJAkcr3T7MKG9ilOK7B(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_JpKRJAkcr3T7MKG9ilOK7B(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: JpKRJAkcr3T7MKG9ilOK7B.\n"
...
mxArray *cgxe_JpKRJAkcr3T7MKG9ilOK7B_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_JpKRJAkcr3T7MKG9ilOK7B_fallback_info(void)
{
