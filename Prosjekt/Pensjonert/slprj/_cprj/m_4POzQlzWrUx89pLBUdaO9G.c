...
#include "m_4POzQlzWrUx89pLBUdaO9G.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0_data[], int32_T
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2]);
static void mw__internal__system___fcn(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
...
static const mxArray *emlrt_marshallOut(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
...
static void cgxe_mdl_set_sim_state(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
...
static void init_simulink_io_address(InstanceStruct_4POzQlzWrUx89pLBUdaO9G
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  creal_T u_tmp3_data[388];
  creal_T y_tmp0_data[388];
  real_T *DampingFactor;
  real_T *NormalizedLoopBandwidth;
  real_T *SamplesPerSymbol;
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int16_T iv1[8] = { 388, 1, 1, 1, 1, 1, 1, 1 };
  ...
  u0_size[2], creal_T b_y0_data[], int32_T y0_size[2])
{
  ...
  emlrtDimSizeGeqCheckR2012b(388, b_y0_size[0], &emlrtECI, (void *)sp);
  ...
  *prevHalfSymbolOut)
{
  ...
  emlrtStack b_st;
  emlrtStack st;
  creal_T phaseCorrection_data[388];
  creal_T b;
  real_T DDSOut;
  real_T loopFiltOut;
  real_T phErr;
  ...
  for (k = 0; k < i; k++) {
    ...
    for (i1 = 0; i1 < loop_ub; i1++) {
      loopFiltOut = tPrevHalfSymbol.vector.data[i1].re * b.re -
        tPrevHalfSymbol.vector.data[i1].im * b.im;
      DDSOut = tPrevHalfSymbol.vector.data[i1].re * b.im +
        tPrevHalfSymbol.vector.data[i1].im * b.re;
      prevHalfSymbolRot.vector.data[i1].re = loopFiltOut;
      prevHalfSymbolRot.vector.data[i1].im = DDSOut;
    }
  ...
  for (i = 0; i < loop_ub; i++) {
    DDSOut = output_data[i].re * b.im + output_data[i].im * b.re;
    output_data[i].re = output_data[i].re * b.re - output_data[i].im * b.im;
    output_data[i].im = DDSOut;
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0_data = (creal_T (*)[388])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->u0_sizes = (int32_T (*)[2])cgxertGetCurrentInputPortDimensions
    (moduleInstance->S, 0);
  moduleInstance->y0_data = (creal_T (*)[388])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
...
/* CGXE Glue Code */
static void mdlOutputs_4POzQlzWrUx89pLBUdaO9G(SimStruct *S, int_T tid)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_4POzQlzWrUx89pLBUdaO9G(SimStruct *S, int_T tid)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void setSimState_4POzQlzWrUx89pLBUdaO9G(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
  InstanceStruct_4POzQlzWrUx89pLBUdaO9G *moduleInstance =
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G *)calloc(1, sizeof
    (InstanceStruct_4POzQlzWrUx89pLBUdaO9G));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_4POzQlzWrUx89pLBUdaO9G);
  ssSetmdlInitializeConditions(S, mdlInitialize_4POzQlzWrUx89pLBUdaO9G);
  ssSetmdlUpdate(S, mdlUpdate_4POzQlzWrUx89pLBUdaO9G);
  ssSetmdlDerivatives(S, mdlDerivatives_4POzQlzWrUx89pLBUdaO9G);
  ssSetmdlTerminate(S, mdlTerminate_4POzQlzWrUx89pLBUdaO9G);
  ssSetmdlEnable(S, mdlEnable_4POzQlzWrUx89pLBUdaO9G);
  ssSetmdlDisable(S, mdlDisable_4POzQlzWrUx89pLBUdaO9G);
...
static void mdlProcessParameters_4POzQlzWrUx89pLBUdaO9G(SimStruct *S)
{
}

void method_dispatcher_4POzQlzWrUx89pLBUdaO9G(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_4POzQlzWrUx89pLBUdaO9G(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_4POzQlzWrUx89pLBUdaO9G(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_4POzQlzWrUx89pLBUdaO9G(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_4POzQlzWrUx89pLBUdaO9G(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 4POzQlzWrUx89pLBUdaO9G.\n"
...
mxArray *cgxe_4POzQlzWrUx89pLBUdaO9G_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_4POzQlzWrUx89pLBUdaO9G_fallback_info(void)
{
