...
#include "m_BNmbo1Ea7VqbAcCO0SzBCC.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
...
static void CarrierSynchronizer_setupImpl(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[88], creal_T c_y0
  [88]);
static const mxArray *emlrt_marshallOut(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
...
static void carrierSyncCore(const emlrtStack *sp, creal_T input[88], real_T
  *loopFiltState, real_T *integFiltState, real_T *DDSPreviousInp,
  coder_array_creal_T_2D *prevHalfSymbol, real_T *phase, real_T
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[88], real_T phaseEstimate[88],
  coder_array_creal_T_2D *prevHalfSymbolOut);
...
static void init_simulink_io_address(InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC
  *moduleInstance);
  ...
  DampingFactor, real_T NormalizedLoopBandwidth)
{
  ...
  static int8_T iv1[8] = { 88, 1, 1, 1, 1, 1, 1, 1 };
  ...
  b_st.site = &e_emlrtRSI;
  CarrierSynchronizer_setupImpl(&b_st, &moduleInstance->sysobj);
  b_st.site = &e_emlrtRSI;
  ...
  comm_CarrierSynchronizer *obj)
{
  ...
  PhaseRecoveryLoopBandwidth = obj->SamplesPerSymbol / 2.0 + 1.0;
  PhaseRecoveryLoopBandwidth = emlrtNonNegativeCheckR2012b
    (PhaseRecoveryLoopBandwidth, &b_emlrtDCI, (emlrtConstCTX)sp);
  ret = (int32_T)emlrtIntegerCheckR2012b(PhaseRecoveryLoopBandwidth, &emlrtDCI,
    (emlrtConstCTX)sp);
  array_creal_T_2D_SetSize(&obj->pPreviousHalfSymbol, 1, ret);
  for (i = 0; i < ret; i++) {
    obj->pPreviousHalfSymbol.vector.data[i].re = 0.0;
    obj->pPreviousHalfSymbol.vector.data[i].im = 0.0;
  }
  ...
  for (i = 0; i < 4; i++) {
    a[i] = obj->ModulationPhaseOffset[i];
  }
  ...
  [88])
{
  ...
  static char_T b[4] = { 'A', 'u', 't', 'o' };

  static int8_T inSize[8] = { 88, 1, 1, 1, 1, 1, 1, 1 };
  ...
  if (!moduleInstance->sysobj_not_empty) {
    ...
    for (i = 0; i < 4; i++) {
      moduleInstance->sysobj.ModulationPhaseOffset[i] = b[i];
    }
  ...
  if (moduleInstance->sysobj.isInitialized != 1) {
    ...
    d_st.site = &e_emlrtRSI;
    CarrierSynchronizer_setupImpl(&d_st, &moduleInstance->sysobj);
    d_st.site = &e_emlrtRSI;
  ...
  b_st.site = &e_emlrtRSI;
  theta = moduleInstance->sysobj.pLoopFilterState;
  d = moduleInstance->sysobj.pIntegFilterState;
  DDSPreviousInp = moduleInstance->sysobj.pDDSPreviousInput;
  ...
  carrierSyncCore(&c_st, b_u0, &theta, &d, &DDSPreviousInp, &prevHalfSymbol,
                  &phase, &digitalSynthesizerGain, &integratorGain,
                  &proportionalGain, &phaseOffset, c_y0, phaseEstimate,
                  &b_prevHalfSymbol);
  array_creal_T_2D_Destructor(&prevHalfSymbol);
  moduleInstance->sysobj.pLoopFilterState = theta;
  moduleInstance->sysobj.pIntegFilterState = d;
  moduleInstance->sysobj.pDDSPreviousInput = DDSPreviousInp;
  ...
  *moduleInstance, const emlrtStack *sp)
{
  ...
  *(int32_T *)emlrtMxGetData(m) = moduleInstance->sysobj.isInitialized;
  ...
  array_creal_T_2D_Constructor(&c_u);
  array_creal_T_2D_SetSize(&c_u, 1,
    moduleInstance->sysobj.pPreviousHalfSymbol.size[1]);
  b_i = moduleInstance->sysobj.pPreviousHalfSymbol.size[1];
  for (i = 0; i < b_i; i++) {
    c_u.vector.data[i].re =
      moduleInstance->sysobj.pPreviousHalfSymbol.vector.data[i].re;
    c_u.vector.data[i].im =
      moduleInstance->sysobj.pPreviousHalfSymbol.vector.data[i].im;
  }
  ...
  emlrtExportNumericArrayR2013b((emlrtConstCTX)sp, m, &c_u.vector.data[0], 8);
  array_creal_T_2D_Destructor(&c_u);
  emlrtAssign(&u_y, m);
  ...
  emlrtMsgIdentifier *parentId, comm_CarrierSynchronizer *y)
{
  ...
  m = emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0, 12, "pPreviousSample");
  ...
  k_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b((emlrtConstCTX)sp, u, 0,
    17, "pPreviousHalfSymbol")), &thisId, &y->pPreviousHalfSymbol);
  emlrtDestroyArray(&u);
}
  ...
  coder_array_creal_T_2D *prevHalfSymbolOut)
{
  ...
  i = prevHalfSymbol->size[1];
  for (b_i = 0; b_i < i; b_i++) {
    tPrevHalfSymbol.vector.data[b_i].re = prevHalfSymbol->vector.data[b_i].re;
    tPrevHalfSymbol.vector.data[b_i].im = prevHalfSymbol->vector.data[b_i].im;
  }
  ...
  for (k = 0; k < 88; k++) {
    if (tPrevHalfSymbol.size[1] < 2) {
      ...
      b_i = 1;
      i1 = emlrtDynamicBoundsCheckR2012b(tPrevHalfSymbol.size[1], 1,
    ...
    i = i1 - b_i;
    for (i3 = 0; i3 < i; i3++) {
      tPrevHalfSymbol.vector.data[i3].re = tPrevHalfSymbol.vector.data[b_i + i3]
        .re;
      tPrevHalfSymbol.vector.data[i3].im = tPrevHalfSymbol.vector.data[b_i + i3]
        .im;
    }

    array_creal_T_2D_SetSize(&tPrevHalfSymbol, 1, (i1 - b_i) + 1);
    tPrevHalfSymbol.vector.data[i2].re = input[k].re;
    tPrevHalfSymbol.vector.data[i2].im = input[k].im;
    st.site = &ab_emlrtRSI;
    sinVal = sin(*phase);
    cosVal = cos(*phase);
    array_creal_T_2D_SetSize(&prevHalfSymbolRot, 1, tPrevHalfSymbol.size[1]);
    i = tPrevHalfSymbol.size[1];
    for (b_i = 0; b_i < i; b_i++) {
      phErr = tPrevHalfSymbol.vector.data[b_i].re * cosVal -
        tPrevHalfSymbol.vector.data[b_i].im * sinVal;
      im = tPrevHalfSymbol.vector.data[b_i].re * sinVal +
        tPrevHalfSymbol.vector.data[b_i].im * cosVal;
      prevHalfSymbolRot.vector.data[b_i].re = phErr;
      prevHalfSymbolRot.vector.data[b_i].im = im;
    }

    output[k].re = prevHalfSymbolRot.vector.data[emlrtDynamicBoundsCheckR2012b
      (prevHalfSymbolRot.size[1], 1, prevHalfSymbolRot.size[1], &c_emlrtBCI,
       (emlrtConstCTX)sp) - 1].re;
    output[k].im = prevHalfSymbolRot.vector.data[emlrtDynamicBoundsCheckR2012b
      (prevHalfSymbolRot.size[1], 1, prevHalfSymbolRot.size[1], &c_emlrtBCI,
       (emlrtConstCTX)sp) - 1].im;
    st.site = &bb_emlrtRSI;
    b_st.site = &y_emlrtRSI;
    sinVal = signDouble(prevHalfSymbolRot.vector.data[0].re);
    st.site = &cb_emlrtRSI;
    emlrtDynamicBoundsCheckR2012b(prevHalfSymbolRot.size[1], 1,
      prevHalfSymbolRot.size[1], &b_emlrtBCI, &st);
    b_st.site = &y_emlrtRSI;
    cosVal = signDouble(prevHalfSymbolRot.vector.data[prevHalfSymbolRot.size[1]
                        - 1].im);
    phErr = sinVal * prevHalfSymbolRot.vector.data[0].im - cosVal *
      ...
      (prevHalfSymbolRot.size[1], 1, prevHalfSymbolRot.size[1], &d_emlrtBCI,
       (emlrtConstCTX)sp) - 1].re;
    sinVal = phErr * *integratorGain + *loopFiltState;
    *loopFiltState = sinVal;
    cosVal = *DDSPreviousInp + *integFiltState;
    *integFiltState = cosVal;
    *DDSPreviousInp = phErr * *proportionalGain + sinVal;
    *phase = *digitalSynthesizerGain * cosVal;
  ...
  i = tPrevHalfSymbol.size[1];
  for (b_i = 0; b_i < i; b_i++) {
    prevHalfSymbolOut->vector.data[b_i].re = tPrevHalfSymbol.vector.data[b_i].re;
    prevHalfSymbolOut->vector.data[b_i].im = tPrevHalfSymbol.vector.data[b_i].im;
  }
  ...
  for (b_i = 0; b_i < 88; b_i++) {
    phErr = output[b_i].re * cosVal - output[b_i].im * sinVal;
    im = output[b_i].re * sinVal + output[b_i].im * cosVal;
    output[b_i].re = phErr;
    output[b_i].im = im;
  }

  for (i = 0; i < 88; i++) {
    phaseEstimate[i] = -(phaseCorrection[i].re + *phaseOffset);
  }
}
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (creal_T (*)[88])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
  moduleInstance->b_y0 = (creal_T (*)[88])cgxertGetOutputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S, int_T tid)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S, int_T tid)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
  InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *moduleInstance =
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC *)calloc(1, sizeof
    (InstanceStruct_BNmbo1Ea7VqbAcCO0SzBCC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_BNmbo1Ea7VqbAcCO0SzBCC);
  ssSetmdlInitializeConditions(S, mdlInitialize_BNmbo1Ea7VqbAcCO0SzBCC);
  ssSetmdlUpdate(S, mdlUpdate_BNmbo1Ea7VqbAcCO0SzBCC);
  ssSetmdlDerivatives(S, mdlDerivatives_BNmbo1Ea7VqbAcCO0SzBCC);
  ssSetmdlTerminate(S, mdlTerminate_BNmbo1Ea7VqbAcCO0SzBCC);
  ssSetmdlEnable(S, mdlEnable_BNmbo1Ea7VqbAcCO0SzBCC);
  ssSetmdlDisable(S, mdlDisable_BNmbo1Ea7VqbAcCO0SzBCC);
...
static void mdlProcessParameters_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S)
{
}

void method_dispatcher_BNmbo1Ea7VqbAcCO0SzBCC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_BNmbo1Ea7VqbAcCO0SzBCC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_BNmbo1Ea7VqbAcCO0SzBCC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_BNmbo1Ea7VqbAcCO0SzBCC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_BNmbo1Ea7VqbAcCO0SzBCC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: BNmbo1Ea7VqbAcCO0SzBCC.\n"
...
mxArray *cgxe_BNmbo1Ea7VqbAcCO0SzBCC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_BNmbo1Ea7VqbAcCO0SzBCC_fallback_info(void)
{
