...
#include "m_VZO5huNR6l1cf1hR5YsxcD.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[352], creal_T
  c_y0[352]);
...
static const mxArray *emlrt_marshallOut(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
...
static void init_simulink_io_address(InstanceStruct_VZO5huNR6l1cf1hR5YsxcD
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S, int_T tid)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S, int_T tid)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
  InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *moduleInstance =
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD *)calloc(1, sizeof
    (InstanceStruct_VZO5huNR6l1cf1hR5YsxcD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_VZO5huNR6l1cf1hR5YsxcD);
  ssSetmdlInitializeConditions(S, mdlInitialize_VZO5huNR6l1cf1hR5YsxcD);
  ssSetmdlUpdate(S, mdlUpdate_VZO5huNR6l1cf1hR5YsxcD);
  ssSetmdlDerivatives(S, mdlDerivatives_VZO5huNR6l1cf1hR5YsxcD);
  ssSetmdlTerminate(S, mdlTerminate_VZO5huNR6l1cf1hR5YsxcD);
  ssSetmdlEnable(S, mdlEnable_VZO5huNR6l1cf1hR5YsxcD);
  ssSetmdlDisable(S, mdlDisable_VZO5huNR6l1cf1hR5YsxcD);
...
static void mdlProcessParameters_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S)
{
}

void method_dispatcher_VZO5huNR6l1cf1hR5YsxcD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_VZO5huNR6l1cf1hR5YsxcD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_VZO5huNR6l1cf1hR5YsxcD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_VZO5huNR6l1cf1hR5YsxcD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_VZO5huNR6l1cf1hR5YsxcD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: VZO5huNR6l1cf1hR5YsxcD.\n"
...
mxArray *cgxe_VZO5huNR6l1cf1hR5YsxcD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_VZO5huNR6l1cf1hR5YsxcD_fallback_info(void)
{
