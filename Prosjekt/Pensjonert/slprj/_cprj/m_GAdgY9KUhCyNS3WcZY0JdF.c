...
static void cgxe_mdl_start(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
...
static const mxArray *emlrt_marshallOut(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
...
static void init_simulink_io_address(InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S, int_T tid)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S, int_T tid)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
  InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *moduleInstance =
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF *)calloc(1, sizeof
    (InstanceStruct_GAdgY9KUhCyNS3WcZY0JdF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_GAdgY9KUhCyNS3WcZY0JdF);
  ssSetmdlInitializeConditions(S, mdlInitialize_GAdgY9KUhCyNS3WcZY0JdF);
  ssSetmdlUpdate(S, mdlUpdate_GAdgY9KUhCyNS3WcZY0JdF);
  ssSetmdlDerivatives(S, mdlDerivatives_GAdgY9KUhCyNS3WcZY0JdF);
  ssSetmdlTerminate(S, mdlTerminate_GAdgY9KUhCyNS3WcZY0JdF);
  ssSetmdlEnable(S, mdlEnable_GAdgY9KUhCyNS3WcZY0JdF);
  ssSetmdlDisable(S, mdlDisable_GAdgY9KUhCyNS3WcZY0JdF);
...
static void mdlProcessParameters_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S)
{
}

void method_dispatcher_GAdgY9KUhCyNS3WcZY0JdF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_GAdgY9KUhCyNS3WcZY0JdF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_GAdgY9KUhCyNS3WcZY0JdF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_GAdgY9KUhCyNS3WcZY0JdF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_GAdgY9KUhCyNS3WcZY0JdF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: GAdgY9KUhCyNS3WcZY0JdF.\n"
...
mxArray *cgxe_GAdgY9KUhCyNS3WcZY0JdF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_GAdgY9KUhCyNS3WcZY0JdF_fallback_info(void)
{
