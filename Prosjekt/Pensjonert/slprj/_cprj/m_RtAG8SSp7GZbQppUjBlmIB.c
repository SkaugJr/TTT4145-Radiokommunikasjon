...
#include "m_RtAG8SSp7GZbQppUjBlmIB.h"
#include <string.h>
...
static void cgxe_mdl_start(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
...
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  comm_CarrierSynchronizer *obj);
static void mw__internal__call__reset(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth);
static void mw__internal__call__step(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance, const emlrtStack *sp, real_T SamplesPerSymbol, real_T
  DampingFactor, real_T NormalizedLoopBandwidth, creal_T b_u0[100000], creal_T
  c_y0[100000]);
static void CarrierSynchronizer_stepImpl(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance, const emlrtStack *sp, comm_CarrierSynchronizer *obj, creal_T
  input[100000], creal_T output[100000]);
static creal_T expFunc(real_T in);
static const mxArray *emlrt_marshallOut(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
...
static void carrierSyncCore(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance, const emlrtStack *sp, creal_T input[100000], real_T
  ...
  *digitalSynthesizerGain, real_T *integratorGain, real_T *proportionalGain,
  real_T *phaseOffset, creal_T output[100000], real_T b_phaseEstimate[100000],
...
static void init_simulink_io_address(InstanceStruct_RtAG8SSp7GZbQppUjBlmIB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S, int_T tid)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S, int_T tid)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
  InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *moduleInstance =
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB *)calloc(1, sizeof
    (InstanceStruct_RtAG8SSp7GZbQppUjBlmIB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_RtAG8SSp7GZbQppUjBlmIB);
  ssSetmdlInitializeConditions(S, mdlInitialize_RtAG8SSp7GZbQppUjBlmIB);
  ssSetmdlUpdate(S, mdlUpdate_RtAG8SSp7GZbQppUjBlmIB);
  ssSetmdlDerivatives(S, mdlDerivatives_RtAG8SSp7GZbQppUjBlmIB);
  ssSetmdlTerminate(S, mdlTerminate_RtAG8SSp7GZbQppUjBlmIB);
  ssSetmdlEnable(S, mdlEnable_RtAG8SSp7GZbQppUjBlmIB);
  ssSetmdlDisable(S, mdlDisable_RtAG8SSp7GZbQppUjBlmIB);
...
static void mdlProcessParameters_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S)
{
}

void method_dispatcher_RtAG8SSp7GZbQppUjBlmIB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_RtAG8SSp7GZbQppUjBlmIB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_RtAG8SSp7GZbQppUjBlmIB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_RtAG8SSp7GZbQppUjBlmIB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_RtAG8SSp7GZbQppUjBlmIB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: RtAG8SSp7GZbQppUjBlmIB.\n"
...
mxArray *cgxe_RtAG8SSp7GZbQppUjBlmIB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_RtAG8SSp7GZbQppUjBlmIB_fallback_info(void)
{
